...
;pug_debug_line = 15;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_mixins["questionShorttext"] = pug_interp = function(question){
var block = (this && this.block), attributes = (this && this.attributes) || {};
;pug_debug_line = 16;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
...
pug_html = pug_html + "\u003Cinput" + (" class=\"form-control\""+" type=\"text\""+pug_attr("name", "response[responses]["+question.id+"]", true, false)+pug_attr("value", getValue(question.id), true, false)+pug_attr("id", 'question-' + question.id, true, false)+pug_attr("required", question.required, true, false)) + "\u002F\u003E";
;pug_debug_line = 24;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
if (question.description) {
;pug_debug_line = 25;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
...
var block = (this && this.block), attributes = (this && this.attributes) || {};
;pug_debug_line = 31;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + "\u003Clabel" + (" class=\"control-label\""+pug_attr("for", "question-" + question.id, true, false)) + "\u003E";
;pug_debug_line = 31;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = question.question) ? "" : pug_interp)) + "\u003C\u002Flabel\u003E";
;pug_debug_line = 32;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
if (question.description) {
...
pug_html = pug_html + "\u003Ctextarea" + (" class=\"form-control\""+pug_attr("name", "response[responses]["+question.id+"]", true, false)+pug_attr("id", 'question-' + question.id, true, false)+pug_attr("required", question.required, true, false)) + "\u003E\u003C\u002Ftextarea\u003E";
;pug_debug_line = 39;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = getValue(question.id)) ? "" : pug_interp));
};
;pug_debug_line = 41;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_mixins["questionBoolean"] = pug_interp = function(question){
var block = (this && this.block), attributes = (this && this.attributes) || {};
;pug_debug_line = 42;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + "\u003C!-- Default checked --\u003E";
;pug_debug_line = 43;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + "\u003Cdiv class=\"form-check form-switch\"\u003E";
;pug_debug_line = 44;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + "\u003Cinput" + (" class=\"form-check-input\""+" type=\"checkbox\""+pug_attr("name", "response[responses]["+question.id+"]", true, false)+pug_attr("checked", getValue(question.id), true, false)+pug_attr("id", 'question-' + question.id, true, false)) + "\u002F\u003E";
;pug_debug_line = 50;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + "\u003Clabel" + (" class=\"form-check-label\""+pug_attr("for", "question-" + question.id, true, false)) + "\u003E";
;pug_debug_line = 50;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = question.question) ? "" : pug_interp)) + "\u003C\u002Flabel\u003E";
;pug_debug_line = 51;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
if (question.description) {
;pug_debug_line = 52;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + "\u003Cdiv class=\"form-text\"\u003E";
;pug_debug_line = 52;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = question.description) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E";
}
...
;pug_debug_line = 54;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_mixins["questionScale"] = pug_interp = function(question){
var block = (this && this.block), attributes = (this && this.attributes) || {};
;pug_debug_line = 55;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + "\u003Clabel" + (" class=\"control-label\""+pug_attr("for", "question-" + question.id, true, false)) + "\u003E";
;pug_debug_line = 55;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = question.question) ? "" : pug_interp)) + "\u003C\u002Flabel\u003E";
...
;pug_debug_line = 59;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + "\u003Cdiv class=\"form-check form-check-inline\"\u003E";
;pug_debug_line = 60;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + "\u003Cinput" + (" class=\"form-check-input\""+" type=\"radio\""+pug_attr("name", `response[responses][${question.id}]`, true, false)+" value=\"-1\""+pug_attr("id", `question-${question.id}-nr`, true, false)+pug_attr("checked", getValue(question.id)===null || getValue(question.id) === -1, true, false)) + "\u002F\u003E";
...
pug_html = pug_html + "\u003Cdiv class=\"form-check form-check-inline\"\u003E";
;pug_debug_line = 63;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + "\u003Cinput" + (" class=\"form-check-input\""+" type=\"radio\""+pug_attr("name", `response[responses][${question.id}]`, true, false)+" value=\"1\""+pug_attr("id", `question-${question.id}-1`, true, false)+pug_attr("checked", getValue(question.id)===1, true, false)) + "\u002F\u003E";
;pug_debug_line = 64;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
...
;pug_debug_line = 65;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + "\u003Cdiv class=\"form-check form-check-inline\"\u003E";
;pug_debug_line = 66;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + "\u003Cinput" + (" class=\"form-check-input\""+" type=\"radio\""+pug_attr("name", `response[responses][${question.id}]`, true, false)+" value=\"2\""+pug_attr("id", `question-${question.id}-2`, true, false)+pug_attr("checked", getValue(question.id)===2, true, false)) + "\u002F\u003E";
;pug_debug_line = 67;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
...
pug_html = pug_html + "\u003Cinput" + (" class=\"form-check-input\""+" type=\"radio\""+pug_attr("name", `response[responses][${question.id}]`, true, false)+" value=\"3\""+pug_attr("id", `question-${question.id}-3`, true, false)+pug_attr("checked", getValue(question.id)===3, true, false)) + "\u002F\u003E";
...
;pug_debug_line = 71;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + "\u003Cdiv class=\"form-check form-check-inline\"\u003E";
;pug_debug_line = 72;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + "\u003Cinput" + (" class=\"form-check-input\""+" type=\"radio\""+pug_attr("name", `response[responses][${question.id}]`, true, false)+" value=\"4\""+pug_attr("id", `question-${question.id}-4`, true, false)+pug_attr("checked", getValue(question.id)===4, true, false)) + "\u002F\u003E";
...
pug_html = pug_html + "\u003Cinput" + (" class=\"form-check-input\""+" type=\"radio\""+pug_attr("name", `response[responses][${question.id}]`, true, false)+" value=\"5\""+pug_attr("id", `question-${question.id}-5`, true, false)+pug_attr("checked", getValue(question.id)===5, true, false)) + "\u002F\u003E";
;pug_debug_line = 76;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + "\u003Clabel" + (" class=\"form-check-label\""+pug_attr("for", `question-${question.id}-5`, true, false)) + "\u003E";
;pug_debug_line = 76;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + "Strongly Positive (5)\u003C\u002Flabel\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
};
...
;pug_debug_line = 87;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + "\u003Ctable class=\"table table-sm table-striped\"\u003E";
;pug_debug_line = 88;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
...
;pug_debug_line = 110;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
console.log(feedback)
;pug_debug_line = 111;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
...
pug_html = pug_html + "\u003Ca" + (" class=\"btn btn-sm btn-outline-primary feedback-edit\""+pug_attr("data-eventid", event.id, true, false)+" href=\"#\"") + "\u003E";
;pug_debug_line = 124;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + "\u003Ci class=\"fas fa-edit me-1 feedback-icon\"\u003E\u003C\u002Fi\u003E";
;pug_debug_line = 125;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
if (hasFeedback) {
;pug_debug_line = 126;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + "Edit Feedback";
}
else {
;pug_debug_line = 128;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + "Provide Feedback";
}
pug_html = pug_html + "\u003C\u002Fa\u003E";
;pug_debug_line = 129;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + "\u003Ca" + (" class=\"btn btn-sm btn-outline-danger ms-1 feedback-remove\""+pug_attr("data-eventid", event.id, true, false)+" href=\"#\" data-toggle=\"tooltip\" title=\"Remove from List\"") + "\u003E";
;pug_debug_line = 135;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + "\u003Ci class=\"fas fa-trash fa-fw feedback-icon\"\u003E\u003C\u002Fi\u003E\u003C\u002Fa\u003E\u003C\u002Ftd\u003E\u003C\u002Ftr\u003E";
      }
  } else {
    var $$l = 0;
...
;pug_debug_line = 147;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + "\u003Cspan class=\"fa fa-plus\"\u003E\u003C\u002Fspan\u003E";
;pug_debug_line = 148;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
pug_html = pug_html + " Add Event\u003C\u002Fbutton\u003E\u003C\u002Fdiv\u003E\u003C\u002Ftd\u003E\u003C\u002Ftr\u003E\u003C\u002Ftfoot\u003E\u003C\u002Ftable\u003E\u003C\u002Fdiv\u003E";
};
;pug_debug_line = 150;pug_debug_filename = "views\u002Fpartials\u002Fsurvey.pug";
...
pug_mixins["questionEvents"](events, userEvents);}.call(this,"console" in locals_for_with?locals_for_with.console:typeof console!=="undefined"?console:undefined,"events" in locals_for_with?locals_for_with.events:typeof events!=="undefined"?events:undefined,"getValue" in locals_for_with?locals_for_with.getValue:typeof getValue!=="undefined"?getValue:undefined,"userEvents" in locals_for_with?locals_for_with.userEvents:typeof userEvents!=="undefined"?userEvents:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line, pug_debug_sources[pug_debug_filename]);};return pug_html;}